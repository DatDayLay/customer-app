/**
  ...
  *
  * @checksum - e79dcc3730d4099df4f32be48e9a233059f925d3aaf501f63db5ea108773b08b
  * @variables - radius=rounded-xl,accentColor=pink,colorTemperature=gray,spacing=2.5,scale=sm,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
